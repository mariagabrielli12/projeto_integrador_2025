...
// Busca os dados principais do aluno E do responsável
$aluno = null;
$stmt_aluno = $conexao->prepare(
    "SELECT 
        a.nome_completo, a.data_nascimento, a.id_turma, t.nome_turma,
    ...
    <div class="card-body">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" value="<?php echo htmlspecialchars(decodificar_dado($aluno['nome_responsavel'])); ?>" readonly>
            </div>
            <div class="form-group">
                <label>Telefone do Responsável</label>
                <input type="text" value="<?php echo htmlspecialchars(decodificar_dado($aluno['telefone_responsavel'])); ?>" readonly>
            </div>
        </div>
